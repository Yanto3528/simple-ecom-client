...
export type Props<T> = T extends ConfigSchema ? ConfigVariants<T> & ClassProps : ClassProps;

export type Config<T extends ConfigSchema> = {
  variants?: T;
  defaultVariants?: ConfigVariants<T>;
  variantsFunction?: Record<string, (variants: Omit<Props<T>, 'className'>) => string>;
